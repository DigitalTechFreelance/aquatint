  ...
  return (
    <div className="bs-infography typ-about">
      ...
      <div className="img-wrap">
        <img src={`http://localhost:1337${image.data.attributes.url}`} alt={image.data.attributes.alternativeText} title={image.data.attributes.name} width="100%" height="auto"/>
      </div>
    </div>
  )
}
